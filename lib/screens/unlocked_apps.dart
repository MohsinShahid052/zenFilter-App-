...
import 'package:zenFilter/executables/controllers/password_controller.dart';
import 'package:zenFilter/widgets/confirmation_dialog.dart';
...
// import 'package:zenFilter/screens/search.dart';
                    ...
                    await showGeneralDialog(
                      ...
                      pageBuilder: (context, animation1, animation2) {
                        return const ConfirmationDialog(
                            heading: "Stop",
                            bodyText: "Sure you want to stop zenFilter");
                      },
                    ).then((value) {
                      if (value as bool) {
          ...
          actions: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: IconButton(
                  onPressed: () {
                    // Your onPressed logic for disabled icon
                  },
                  icon: Icon(
                    Icons.disabled_by_default_rounded,
                    color: Theme.of(context).primaryColor,
