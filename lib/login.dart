...
class _LoginSignupPageState extends State<LoginSignupPage> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        buildTextButton(Icons.games_outlined,
  ...
  Container SignInSection() {
    return Container(
                    ...
                    child: Column(children: [
                      buildTextField(Icons.mail_lock_outlined,'abc@gmail.com',false, true),
  ...
  Container SignupSection() {
    return Container(
                    margin: EdgeInsets.only(top: 20),
                    child: Column(children: [
                      buildTextField(Icons.account_circle_outlined,'User Name',false,false),
